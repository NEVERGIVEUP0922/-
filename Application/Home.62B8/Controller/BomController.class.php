...
//        ];
    ...
    protected function mergeCondition($request){
        ...
        foreach ($request['data'] as $requestKey=>$value){
            ...
            $bomOne=$this->queryCondition($where,$cate,$brand,$replaceWhere,$value['p_sign']);
            if($bomOne){
...
//               }
    ...
    protected  function queryCondition($where,$cate,$brand,$replaceWhere,$p_sign){
        ...
        return $this->productBomlist($where,$andWhere,$replaceWhere,$p_sign);
    }

    protected  function productBomlist($where,$andWhere,$replaceWhere,$p_sign){
